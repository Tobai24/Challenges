...
Revision ID: 17d87244bb85
Revises: 
Create Date: 2025-01-20 11:40:51.604441
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['post_id'], ['sqlpost.id'], ondelete='CASCADE'),
